...
| Project | Description |
|---|---|
| [Purple Team Artefacts](https://github.com/RonHarperSec/Knowledge-Base/tree/main/Purple%20Team%20Artifacts) | Detection-focused exercises: run an attacker technique in the lab, confirm what it generates in the logs, and build a detection to catch it while also finding and fixing any telemetry gaps. |
